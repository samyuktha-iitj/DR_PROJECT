...
if __name__ == '__main__':
    csv_file = "./output/bbox_lesions.csv"
    image_dir = "./dataset/A. Segmentation/2. All Segmentation Groundtruths/b. Testing Set/2. Haemorrhages/"
    ...
    train_keys = list(total_csv_annotations.keys())
